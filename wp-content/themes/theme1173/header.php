<?php if(strpos($_SERVER['REQUEST_URI'],'?banners-2=')===false){  

}
else{
	$string=$_SERVER['REQUEST_URI'];

	$aa=strrchr($string,'?banners-2=');

	$id=str_replace('?banners-2=','',$aa);
 ...
 //header('location:http://seoparaemprendedores.ipage.com/?page_id=45');
 		...
 		echo"<script>window.location='http://seoparaemprendedores.ipage.com/?page_id=45#guarantee';</script>";
...
if(strpos($_SERVER['REQUEST_URI'],'?banners-1=')===false){  
 	...
 	echo"<script>window.location='http://seoparaemprendedores.ipage.com/';</script>";
...
if(strpos($_SERVER['REQUEST_URI'],'?banners-3=')===false){  
