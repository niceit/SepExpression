...
<li>
<?php 
	$ban1 = get_option('sosa_banner1'); 
	$url1 = get_option('sosa_url1'); 
	$lab1 = get_option('sosa_lab1'); 
	$alt1 = get_option('sosa_alt1');
?>
...
<li>
<?php 
	$ban2 = get_option('sosa_banner2'); 
	$url2 = get_option('sosa_url2'); 
	$lab2 = get_option('sosa_lab2'); 	
	$alt2 = get_option('sosa_alt2');
?>
...
<li>
<?php 
	$ban3 = get_option('sosa_banner3'); 
	$url3 = get_option('sosa_url3'); 
	$lab3 = get_option('sosa_lab3'); 
	$alt3 = get_option('sosa_alt3');	
?>
...
<li>
<?php 
	$ban4 = get_option('sosa_banner4'); 
	$url4 = get_option('sosa_url4');
	$lab4 = get_option('sosa_lab4'); 
	$alt4 = get_option('sosa_alt4');	
?>
